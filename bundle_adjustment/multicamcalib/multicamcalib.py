...
if __name__ == "__main__":
    ...
    vae_config = {"z_dim": vae["z_dim"], "kl_weight": vae["kl_weight"], "lr": vae["lr"], "n_epochs": vae["n_epochs"], "batch_size": vae["batch_size"], 
                  "device": 'cuda' if torch.cuda.is_available() else 'cpu', "debug": False}
